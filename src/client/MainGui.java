...
//import static client.Client1.sendConnectionDetails;
...
public class MainGui {
	...
	private void initialize() {
		...
		frameMainGui.getContentPane().setBackground(Color.WHITE);
		...
		JLabel lblFriendsName = new JLabel("Search Friend");
		...
		txtNameFriend.setBounds(100, 419, 369, 28);
		...
		btnChat.setBounds(90, 465, 64, 44);
		frameMainGui.getContentPane().add(btnChat);
		btnChat.setIcon(null);
		...
		listActive.setBackground(Color.LIGHT_GRAY);
		...
		listActive.setBounds(12, 152, 457, 171);
